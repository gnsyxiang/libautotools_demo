...
cppflag=-mcpu=cortex-m7 -mthumb -mfpu=fpv5-d16 -mfloat-abi=hard -ffunction-sections -fdata-sections -I/opt/toolchains/mcu/arm-gnu-toolchain-11.3.rel1-x86_64-arm-none-eabi/include
